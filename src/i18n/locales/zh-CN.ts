...
export const zhCN: Record<string, string> = {
  ...
  "settings.translate.provider.alibaba": "阿里百炼",
  ...
  "settings.translate.provider.siliconflow": "硅基流动 SiliconFlow",
  "settings.translate.provider.openai": "OpenAI",
  "settings.translate.provider.custom": "自定义（OpenAI 兼容）",
  "settings.translate.apiKey": "API Key",
  "settings.translate.apiKeyPlaceholder": "粘贴 API Key（保存在系统凭据管理器）",
  "settings.translate.apiKeySave": "保存 Key",
  "settings.translate.apiKeySaved": "已保存",
  "settings.translate.apiKeyConfigured": "已配置",
  ...
  "settings.translate.testFail": "连接失败",
  "settings.translate.targetLang": "目标语言",
  "settings.translate.targetLang.auto": "自动（中英互译）",
  "settings.translate.tone": "语体",
  ...
  "settings.translate.resultMode.bilingual": "双语对照",
  "settings.translate.resultMode.clipboard": "复制到剪贴板",
  "settings.translate.customPrompt": "自定义 Prompt（可选）",
  ...
  "translate.full.segmentFailed": "该段翻译失败，已保留原文",
  "translate.full.segmentFailedCount": "{count} 段翻译失败，已保留原文",
  // v0.6.1 问题2：取消翻译气泡
  "translate.undo.label": "取消翻译",
  "translate.undo.tip": "取消翻译并恢复原文",
  // v0.6.1 问题5：模式切换悬浮按钮
  "mode.switch.toSplit": "切换到分屏模式",
  "mode.switch.toPreview": "切换回阅读模式",
  "translate.streaming": "翻译中…",
  "translate.retry": "重试",
  "translate.replace": "替换",
  "translate.bilingual": "双语",
  "translate.copy": "复制",
  ...
  "translate.error.TRUNCATED": "译文因长度限制被截断",
  "translate.error.STREAM": "连接中断，请重试",
  "translate.error.NO_KEY": "尚未配置翻译 API Key，请在设置中填写",
  "translate.error.PROVIDER": "服务商返回错误",
