...
- 🔍 **全局搜索与替换**（`Ctrl+F` / `Ctrl+H`）— 浮动窗口，支持拖动（0.3.5 改进）
...
- 📊 **表格可视化编辑** — 行列增删、列对齐、列宽/行高拖拽调整、浮动工具栏（0.3.0 新增，0.3.5 完善列宽拖拽）
...
前往 [Releases](../../releases) 页面下载 0.3.5 版本安装包：

- **`LightMD_0.3.5_x64_en-US.msi`** — MSI 安装包，适合普通用户，支持卸载
- **`LightMD_0.3.5_x64-setup.exe`** — 自解压安装包，单文件安装，免管理员权限
